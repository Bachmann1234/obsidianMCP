...
def test_list_all_tags(temp_index, sample_notes):
    ...
    expected_tags = {"python", "programming", "beginner", "advanced", "cooking", "recipe", "italian"}
...
def test_get_stats(temp_index, sample_notes):
    ...
    expected_fields = {"path", "title", "content", "tags", "wikilinks", "created_date", "modified_date", "frontmatter"}
