...
class VectorSearchEngine:
    ...
    def add_note(self, note: ObsidianNote) -> None:
        ...
        try:
            ...
            metadata = {
                ...
                "created_date": note.created_date.isoformat() if note.created_date else "",
                "modified_date": note.modified_date.isoformat() if note.modified_date else "",
    ...
    def search(
        ...
        try:
            ...
            logger.debug(f"Vector search returned {len(processed_results)} results for query: {query}")
    ...
    def rebuild_index(self, notes: List[ObsidianNote]) -> None:
        ...
        try:
            ...
            for i in range(0, len(notes), batch_size):
                ...
                logger.info(f"Processed {min(i + batch_size, len(notes))}/{len(notes)} notes")
